        ...
        if state not in exploredState:
            ...
            for succ in successors:
                ...
                if coordinates not in exploredState:
                    ...
                    states.push((coordinates, actions + [directions]), problem.getCostOfActionSequence(newCost))
        ...
        if state not in exploredState:
            ...
            for succ in successors:
                ...
                if coordinates not in exploredState:
                    ...
                    nCost = problem.getCostOfActionSequence(nActions) + heuristic(coordinates, problem)
